...
'change-user-info': 'تغيير معلومات المستخدم',
        ...
        'protocol-time': 'وقت المحضر',
        'protocol-room': 'قاعة المحضر',
        'basic-protocol-info': 'المعلومات الأساسية للمحضر',
            'protocol-assignment': 'تخصيص المحضر',
    'assign-by-department': 'تخصيص حسب القسم',
    'assign-by-committee': 'تخصيص حسب اللجنة',
    'assign-by-both': 'تخصيص حسب القسم واللجنة',
    'select-department': 'اختر القسم',
    'select-folder': 'اختر المجلد',
    'select-folder-first': 'اختر القسم أولاً',
    'select-committee': 'اختر اللجنة',
    'select-committee-folder': 'اختر مجلد اللجنة',
    'select-committee-first': 'اختر اللجنة أولاً',
    'topics-section': 'مواضيع المحضر',
        ...
        'topic-discussion': 'المناقشة الرئيسية',
        'topic-duration': 'مدة',
        'topic-end-date': 'تاريخ انتهاء',
        'topic-recommendations': 'التوصيات',
        'topic-responsibility': 'المسؤولية',
        'remove-topic': 'حذف',
        ...
        'side-discussion-recommendations': 'التوصيات',
        'side-discussion-responsibility': 'المسؤولية',
        ...
        'placeholder-room': 'أدخل اسم القاعة هنا',
        'placeholder-topic-subject': 'أدخل موضوع المحضر هنا',
        'placeholder-topic-discussion': 'أدخل المناقشة الرئيسية بالتفصيل',
        'placeholder-topic-duration': 'مثال: 30 يوم',
        'placeholder-topic-end-date': 'yyyy/mm/dd',
        'placeholder-topic-recommendations': 'أدخل التوصيات هنا',
        'placeholder-topic-responsibility': 'أدخل المسؤول هنا',
        'placeholder-side-discussion-content': 'أدخل محتوى المناقشة الجانبية',
        'placeholder-side-discussion-duration': 'مثال: 15 يوم',
        'placeholder-side-discussion-recommendations': 'أدخل التوصيات هنا',
        'placeholder-side-discussion-responsibility': 'أدخل المسؤول هنا',
...
'good-catch': 'إلتقاطة جيدة',
        ...
        // عناصر إضافية للتفويض
        'delegation-confirmation-title': 'اقرار التفويض',
        'full-name': 'الاسم الكامل',
        'id-number': 'رقم الهوية',
        'bulk-delegation-all-pending': 'تفويض شامل لجميع الملفات المعلقة',
        'individual-delegation': 'تفويض فردي',
        'individual-delegation-no-files': 'تفويض فردي - لا توجد ملفات محددة',
        'files-summary': 'ملخص الملفات',
        'files-list': 'قائمة الملفات',
        ...
        'protocol': 'محضر',
        'file': 'ملف',
        'delegation-type-bulk': 'تفويض شامل',
        'delegation-type-individual': 'تفويض فردي',
        'delegation-statement-text': 'أقر بأنني أقبل التفويض للموظف',
        'delegation-statement-id': 'ذو رقم الهوية',
        'delegation-statement-sign': 'بالتوقيع بالنيابة عنه',
        'delegation-statement-all-files': 'لجميع الملفات المعلقة',
        'delegation-statement-selected-files': 'للملفات المحددة',
        'delegation-statement-single-file': 'للملف المحدد',
        'reject-delegation': 'رفض التفويض',
        'cancel-delegation': 'إلغاء',
        'accept-delegation': 'قبول التفويض',
        ...
        "page-title": "نظام إدارة الجودة والمعايير",
        "main-title": "نظام إدارة الجودة والمعايير",
        "main-title1": "الصفحة الرئيسية",
        "current-lang": "عربي",
        "arabic": "عربي",
        "english": "English",
        "quality-management-title": "إدارة الجودة",
        "quality-management-subtitle": "نظام متكامل لإدارة الجودة والتحسين المستمر",
        "quality-management-description": "نظام شامل لإدارة الجودة يتضمن الأحداث الطارئة، اللجان، المحاضر، الأقسام، الملفات، والإعتمادات",
        "quality-standards-title": "معايير الجودة",
        "quality-standards-subtitle": "نظام معايير الجودة والمواصفات",
        "quality-standards-description": "نظام متخصص في معايير الجودة يتضمن إدارة الأقسام، الملفات، والإعتمادات مع واجهة إدارية متقدمة",
        "emergency-events": "الأحداث الطارئة",
        "committees": "اللجان",
        "minutes": "المحاضر",
        "departments": "الأقسام",
        "files": "الملفات",
    ...
    en: {
        ...
        // Additional delegation elements
        'delegation-confirmation-title': 'Delegation Confirmation',
        'full-name': 'Full Name',
        'id-number': 'ID Number',
        'bulk-delegation-all-pending': 'Bulk delegation for all pending files',
        'individual-delegation': 'Individual Delegation',
        'individual-delegation-no-files': 'Individual delegation - no specific files',
        ...
        'protocol': 'Protocol',
        'file': 'File',
        'delegation-type-bulk': 'Bulk Delegation',
        'delegation-type-individual': 'Individual Delegation',
        'delegation-statement-text': 'I confirm that I accept the delegation for the employee',
        'delegation-statement-id': 'with ID number',
        'delegation-statement-sign': 'to sign on my behalf for',
        'delegation-statement-all-files': 'all pending files',
        'delegation-statement-selected-files': 'the selected files',
        'delegation-statement-single-file': 'the selected file',
...
'change-user-info': 'Change User Info',
    ...
    'protocol-room': 'Protocol Room',
    'basic-protocol-info': 'Basic Protocol Information',
    'protocol-assignment': 'Protocol Assignment',
    'assign-by-department': 'Assign by Department',
    'assign-by-committee': 'Assign by Committee',
    'assign-by-both': 'Assign by Department and Committee',
    'select-department': 'Select Department',
    'select-folder': 'Select Folder',
    'select-folder-first': 'Select Department First',
    'select-committee': 'Select Committee',
    'select-committee-folder': 'Select Committee Folder',
    'select-committee-first': 'Select Committee First',
    ...
    'topic-discussion': 'Main Discussion',
    ...
    'side-discussion-recommendations': 'Recommendations',
    'side-discussion-responsibility': 'Responsibility',
    'remove-side-discussion': 'Remove Side Discussion',
    'save-protocol': 'Save Protocol',
    'reset-form': 'Reset Form',
    'placeholder-protocol-title': 'Enter protocol title here',
    'placeholder-date': 'yyyy/mm/dd',
    'placeholder-time': 'HH:MM',
    'placeholder-room': 'Enter room name here',
    'placeholder-topic-subject': 'Enter topic subject here',
    'placeholder-topic-discussion': 'Enter main discussion in detail',
    'placeholder-topic-duration': 'Example: 30 days',
    'placeholder-topic-end-date': 'yyyy/mm/dd',
    'placeholder-topic-recommendations': 'Enter recommendations here',
    'placeholder-topic-responsibility': 'Enter responsible person here',
    'placeholder-side-discussion-content': 'Enter side discussion content',
    'placeholder-side-discussion-duration': 'Example: 15 days',
    'placeholder-side-discussion-recommendations': 'Enter recommendations here',
    'placeholder-side-discussion-responsibility': 'Enter responsible person here',
...
'download_reports_approvals': 'Download Reports Approvals',
        ...
        'user': 'User',
        "page-title": "Quality Management and Standards System",
        "main-title": "Quality Management and Standards System",
        "current-lang": "English",
        "arabic": "عربي",
        "english": "English",
        "quality-management-title": "Quality Management",
        "quality-management-subtitle": "Integrated system for quality management and continuous improvement",
        "quality-management-description": "Comprehensive quality management system including emergency events, committees, minutes, departments, files, and accreditations",
        "quality-standards-title": "Quality Standards",
        "quality-standards-subtitle": "Quality standards and specifications system",
        "quality-standards-description": "Specialized system in quality standards including department management, files, and accreditations with advanced administrative interface",
        "emergency-events": "OVRS",
        "committees": "Committees",
        "minutes": "Minutes",
        "departments": "Departments",
        "files": "Files",
        ...
        "developers": "Prepared by Engineer Hani Miyajan | Implemented by Engineer Sara Al-Uhaibi",
        'back': 'Back',
        'home': 'Home',
